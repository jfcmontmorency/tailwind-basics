...
```
index.html              Page unique, structure des écrans (accueil / jeu / fin)
src/main.js             Logique du jeu (rendu des niveaux, vérification, progression)
src/style.css           Import Tailwind/daisyUI, safelist, animations custom
src/levels-bases.js     Niveaux de l'étape "Bases"
src/levels-layout.js    Niveaux de l'étape "Layout"
src/levels-responsive.js Niveaux de l'étape "Responsive"
```
